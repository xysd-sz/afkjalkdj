...
static unsigned char mouse_left_down; //鼠标左键是否按下
static unsigned char mouse_right_down; //鼠标右键是否按下
static unsigned char mouse_left_move; //鼠标是否向左移动
static unsigned char mouse_down_move;//鼠标是否向下移动
static unsigned char mouse_x_overflow; // x溢出标志位
static unsigned char mouse_y_overflow; // y溢出标志位
static unsigned int mouse_x_position; //记录鼠标的 x 轴位置
static unsigned int mouse_y_position;//记录鼠标的 y 轴位置
